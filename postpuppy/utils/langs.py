    ...
    "dog": {
        ...
        "utils.shipments": {
            ...
            "new_shipment_with_tracking": {
                "pub_msg": f':neodog_laptop_notice: "wrrf! your *"{{}}"*, is on its way, wag wag! a`nd guess what, friend! you can track it too, tail wags! visit my <slack://app?team=T0266FRGM&id={env.slack_app_id}|bed> to see where it\'s at, woof woof!!1 🐾',
            ...
            "type_text_updated": ':neodog_notice: hey hey hey hey hey!!!! friend, it looks like your *"{}"* is now {}! :3',
